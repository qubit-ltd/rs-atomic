...
- **函数式更新**：`fetch_update`、`update_and_get`、`try_update`、`try_update_and_get`、`fetch_accumulate`
...
| **基于 CAS 的算术和更新操作** (`fetch_mul()`、`fetch_div()`、`fetch_update()`、`update_and_get()`、`try_update()`、`try_update_and_get()`、`fetch_accumulate()`) | `AcqRel` / `Acquire` | CAS 循环标准语义 |
